...
//            //可以选择发送文件...
//            DataSource source = new FileDataSource("D:\\Java_Code\\email-boot2\\src\\main\\resources\\static\\logo.png");
...
//            multipart.addBodyPart(attachPart);
    ...
    public static void main(String[] args) {
        ...
        String sender = "crvid39@outlook.com";
        String password = "Aa159753"; //填写你的outlook帐户的密码

        // 收件人邮箱地址
        String receiver = "1145208696@qq.com";
